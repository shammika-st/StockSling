...
namespace StockSling
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IForecastBusiness, ForecastBusiness>();

            //Data Classes
            services.AddScoped<ICounterData, CounterData>();
            services.AddScoped<IAdminData, AdminData>();
            services.AddScoped<IForecastData, ForecastData>();
        }
